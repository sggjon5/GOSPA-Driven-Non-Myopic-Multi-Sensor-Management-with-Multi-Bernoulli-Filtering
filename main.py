...
from utils import update_anim_plot, merge_measurements, merge_gaussians, calculate_average_algorithm_GOSPA_error, GOSPA_breakdown_plots, save_frame_as_image
import Parameters
...
for mc_run in range(Parameters.number_of_mc_runs):
    ...
    # Initialising birth locations of sensors
    oSensor1.current_sensor_position = np.array([[5],[150]]) # [x,y]
    oSensor2.current_sensor_position = np.array([[-5],[150]]) # [x,y]
