...
#########################################
#   S E N S O R   B I R T H   P O S I T I O N S
#########################################
# Keep the existing sensor y-birth positions, but randomise x for each MC run.
# X is sampled uniformly from [obstacle_x_min - margin, obstacle_x_max + margin]
# for the first obstacle in Parameters.obstacles_list (if present).
#
# NOTE: the y-values below match the original hardcoded values in main.py.

sensor_birth_y_values = [150, 150]
sensor_birth_x_margin = 40
